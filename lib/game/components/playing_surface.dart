...
class PlayingSurface extends PositionComponent {
  ...
  void moveCardsTo(TricksPile pile, void Function() onMoveEffectComplete) {
    assert(
    ...
    playerCard.add(
      createMoveEffect(playerCard, pile.position, () {
    ...
    opponentCard.add(
      createMoveEffect(opponentCard, pile.position, () {
